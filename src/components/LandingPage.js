  ...
  return (
    <div className="landing-page">
      ...
      <div className="floating-nav-buttons">
        ...
        <a href="https://x.com/apt_ninja" target="_blank" rel="noopener noreferrer" className="nav-link social-link" aria-label="Twitter">
        ...
        <div className="hero-section">
          <div className="hero-content">
            ...
            <button className="hero-multiplayer-button" onClick={handleMultiplayerClick}>
              <span className="multiplayer-icon"><GiCrossedSwords /></span>
              Multiplayer Arena
            </button>
          </div>
        </div>
